...
__PACKAGE__->set_up_table( 'crew' );
__PACKAGE__->has_many( officers => 'Police::Dispatch::Officer' );
__PACKAGE__->has_many( calls => ['Police::Dispatch::CrewCall' => 'call'] );

=head1 NAME

Police::Dispatch::Crew - Maintain information about a collection of
Police::Dispatch::Officers that act as one Unit.
