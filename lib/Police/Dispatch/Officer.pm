package Police::Dispatch::Officer;
...
__PACKAGE__->set_up_table( 'officer' );

# __PACKAGE__->table( 'officer' );
# __PACKAGE__->columns( All => qw( officerid name serial_number crew ) );
# __PACKAGE__->has_a( crew => 'Police::Dispatch::Crew' );

=head1 NAME

Police::Dispatch::Officer - Track information about individual officers.
...
C<bug-police-dispatch-officer at rt.cpan.org>, or through the web interface at
...
1; # End of Police::Dispatch::Officer
